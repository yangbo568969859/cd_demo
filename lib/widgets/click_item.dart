...
import 'package:data_analysis/style/colors.dart';
import 'package:data_analysis/style/text.dart';
                ...
                Expanded(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(color: this.value != '' ? Color(0xFF9e9e9e) : Color(0xFF9e9e9e), fontSize: 13),
                    ),
                  ),
                ),
                Opacity(
                  ...
                  child: Padding(
                    ...
                    // child: Image.asset('assets/images/icon/icon_arrow_right.png', width: 16, height: 12,),
                  ),
                ),
